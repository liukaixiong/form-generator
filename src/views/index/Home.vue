  ...
  <div class="container">
    <div class="left-board">
      ...
      <el-scrollbar class="left-scrollbar">
        <el-tabs type="border-card" class="left-scrollbar">
            <el-tab-pane v-for="(itemObj, listIndex) in leftComponents" :key="listIndex" :value="itemObj.title" :label="itemObj.title">
              <div v-for="(item, listIndex) in itemObj.list" :key="listIndex">
...
import customConfig from '@/components/generator/customConfig'
import {
  exportDefault,
  beautifierConf,
  isNumberStr,
  ...
  methods: {
    ...
    cloneComponent(origin) {
      ...
      if (
        ...
        config.layout === "draggableFormItem"
      ) {
